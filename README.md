...
## How to ask for content

- "Write the page for slices" → produces `03-composite-types/02-slices.md`
- "Write Part 7" → produces every file under `07-concurrency/` in order
- "Write the page on goroutine internals" → produces `12-runtime/05-goroutine-internals.md`

When done with a request, the reply is just: `done`.
